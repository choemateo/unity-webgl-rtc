...
<div class="container">
    <div class="row justify-content-center  h-100">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <div class="card-header text-center mb-1">{{ __('Register') }}</div>

                    <form method="POST" action="{{ route('register') }}">
                        @csrf

                        <div class="form-group" style="color: #fff">
                            <label for="name" class="col-md-12 text-md-left">{{  __('Name')  }}</label>
                        ...
                        <div class="form-group mb-3" style="margin-top: 1.5rem">
                            <div class="col-md-12">
                                <input type="submit" id="Regsubmit" class="form-control" value="{{ __('Register') }}">
                            </div>
                        </div>
                    </form>
                </div>
